...
<Image
  src="/food/broadway/spanish-octopus.png"
  alt="Spanish Octopus"
  width="75"
  height="100"
  priority
...
<Image
  src="/food/broadway/chilean-seabass.png"
  alt="Chilean Seabass"
  width="75"
  height="100"
  layout="responsive"
  placeholder="blur"
  blurDataURL="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mO88xQAAqMBwyPcBc0AAAAASUVORK5CYII="
/>
...
<Image
  src="/food/broadway/skirt-steak.png"
  alt="Chilean Seabass"
  width="75"
  height="100"
  layout="responsive"
