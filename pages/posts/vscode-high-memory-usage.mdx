...
date: 2021/03/01
description: Are you using VS Code and seeing high memory usage from something called "Code Helper (Renderer)"? Find out how to get rid of this issue.
tag: technology
author: Paul Chong
---

# VS Code High Memory Usage and The Fix

import HitCounter from '../../components/HitCounter';

<HitCounter slug='vscode-high-memory-usage' />
